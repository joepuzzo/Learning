...
$(document).ready(function() {
  var original_color, original_weight;
  $('.tour').on('mouseenter', function() {
    original_color  = $(this).css('background-color');
    original_weight = $(this).css('font-weight');
    $(this).css({'background-color': '#252b30', 'font-weight': 'bold'});
    $(this).find('.photos').show();
  });
  $('.tour').on('mouseleave', function() {
    $(this).css({'background-color': original_color, 'font-weight': original_weight});
  });

});


// A better way without css in JS
$(document).ready(function() {
  $('.tour').on('mouseenter', function() {
